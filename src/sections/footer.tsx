...
const Footer: React.FC = () => {
  return (
    <div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-8 text-[#FE5000] font center">
          <div>
            <div className="pt-4">
              <p className="text-xs sm:text-sm mb-2 sm:mb-4 text-white text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 mt-4">
              <a href="https://www.instagram.com/upnfmweb/?hl=es" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="white" className="bi bi-instagram" viewBox="0 0 16 16">
              ...
              <a href="https://www.linkedin.com/company/upnfcomorazan/?originalSubdomain=hn" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="white" className="bi bi-linkedin" viewBox="0 0 16 16">
              ...
              <a href="https://www.youtube.com/@upnfm-tv8269" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="white" className="bi bi-youtube" viewBox="0 0 16 16">
              ...
              <a href="https://www.tiktok.com/@upnfm.oficial" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
